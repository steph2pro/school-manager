...
<?php
  ...
  ?>
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">Liste des entreprise</h5>
              ...
              <table class="table table-striped" style="width: 100%">
                ...
                <tbody>
                  <?php
                  require 'scripts/conf.php';
                  $sql="select * from entreprises order by id desc";
                  $req=$db->prepare($sql);
                  $req->execute();
                  ...
                  foreach ($resultats as $resultat):
                   $i++;
                    ...
                    $update='updateEntreprise.php?id='.$resultat->id;
                    $delete='scripts/delete_e.php?id='.$resultat->id;
                  ?>
                  <tr>
                    <th scope="row"><?= $i?></th>
                    <td><?= $resultat->nom ?></td>
